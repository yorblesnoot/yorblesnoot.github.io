        ...
        <div className='block'>
          <img src = {selfie} alt='ED' width="20%" height="20%"/>
            <div className='innerblock'>
              <h1>Ed Korb</h1>
              Hi! I'm Eduardo "Ed" Korb and I'm a Web/Unity Developer for-hire. Before that I was a technical writer, editor, and tutor in algebra/calculus/physics/geometry/SAT/GRE/english/spanish/logic/other stuff I've forgotten!
